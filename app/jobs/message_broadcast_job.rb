...
class MessageBroadcastJob < ApplicationJob
  ...
  def render_message_right(message)
    ApplicationController.renderer.render(partial: 'message/message_right', locals: { message: message })
  end

  def render_message_left(message)
    ApplicationController.renderer.render(partial: 'message/message_left', locals: { message: message })
  end
end
